...
function patient() {
    ...
    <div className='relative top-0 left-0 '>
      ...
      <div className='grid grid-flow-col auto-cols-max gap-4 items-center ' >
            <button onClick={()=>setAdd(true)} className=' grid grid-cols-[auto_1fr] gap-4 items-center  rounded-lg px-[20px] py-3 bg-green-600 font-bold  text-lg hover:bg-green-800 hover:text-gray-100 transition duration-200 ease-in-out'>
              <img className='w-[30px] h-[30px]' src='patient.png'alt=''></img><p>Add Patient</p>
            </button>
            ...
            {allpatient.map((p,index)=>(<option key={index} value={p.name}>{p.name}-{p.id}</option>))}
            </select>
      ...
      <div>
        <br></br>
        <p className='text-2xl font-semibold'>Patient List</p>
  ...
  <tbody className="divide-y divide-gray-200">
    <tr>
        <td className="px-4 py-3   font-semibold">Patient id</td>
        <td className="px-4 py-3  " ><p>{patient.id}</p></td>
    </tr>   
    <tr>
        <td className="px-4 py-3   font-semibold">Patient Name</td>
        <td className="px-4 py-3  " ><input className='shadow h-auto border-0' onChange={(e)=>setPatientName(e.target.value)}  value={patientname} type="text"></input></td>
    </tr> 
    <tr>
        <td className="px-4 py-3   font-semibold">Patient Password</td>
        <td className="px-4 py-3  " ><input className='shadow h-auto border-0' onChange={(e)=>setPatientPass(e.target.value)}  value={patientpass} type="text"></input></td>
    </tr> 
    <tr>
        <td className="px-4 py-3   font-semibold">Patient Mail</td>
        <td className="px-4 py-3  " ><input className='shadow h-auto border-0' onChange={(e)=>setPatientMail(e.target.value)}  value={patientmail} type="text"></input></td>
    </tr> 
    <tr>
        <td className="px-4 py-3   font-semibold">Patient Mobile</td>
        <td className="px-4 py-3  " ><input className='shadow h-auto border-0' onChange={(e)=>setPatientMobile(e.target.value)}  value={patientmobile} type="text"></input></td>
    </tr>
    <tr>
        <td className="px-4 py-3   font-semibold">Patient DOB</td>
        <td className="px-4 py-3  " ><input className='shadow h-auto border-0' onChange={(e)=>setPatientDob(e.target.value)}  value={patientdob} type="text"></input></td>
    </tr> 
    <tr>
        <td className="px-4 py-3  font-semibold">Patient Gender</td>
        <td className="px-4 py-3  " ><input className='shadow h-auto border-0' onChange={(e)=>setPatientGender(e.target.value)}  value={patientgender} type="text"></input></td>
    </tr>
    <tr>
        <td className="px-4 py-3   font-semibold">Patient Blood Group</td>
        <td className="px-4 py-3  " ><input className='shadow h-auto border-0' onChange={(e)=>setPatientBloodgroup(e.target.value)}  value={patientbloodgroup} type="text"></input></td>
    </tr> 
     
    <tr>
        <td className="px-4 py-3   font-semibold">Patient Address</td>
        <td className="px-4 py-3  " ><input className='shadow h-auto border-0' onChange={(e)=>setPatientAddress(e.target.value)}  value={patientaddress} type="text"></input></td>
    </tr>  
    <tr>
        <td className="px-4 py-3   font-semibold">Patient State</td>
        <td className="px-4 py-3  " ><input className='shadow h-auto border-0' onChange={(e)=>setPatientState(e.target.value)}  value={patientstate} type="text"></input></td>
    </tr> 
    <tr>
        <td className="px-4 py-3   font-semibold">Patient City</td>
        <td className="px-4 py-3  " ><input className='shadow h-auto border-0' onChange={(e)=>setPatientCity(e.target.value)}  value={patientcity} type="text"></input></td>
    </tr>
    <tr>
        <td className="px-4 py-3   font-semibold">Patient Pin</td>
        <td className="px-4 py-3  " ><input className='shadow h-auto border-0' onChange={(e)=>setPatientPin(e.target.value)}  value={patientpin} type="text"></input></td>
    </tr>
    <tr>
  ...
  <div>
    ...
    <form className='grid grid-cols-2 font-semibold'>
      ...
      <div className='mt-4 ml-8'> 
        ...
        <br /><br />
        <select onChange={(e)=>setBg(e.target.value)} className='h-[50px] w-[350px] rounded-2xl shadow-lg text-red-500'>
          <option>A+</option>
          <option>A-</option>
          <option>B+</option>
          <option>B-</option>
