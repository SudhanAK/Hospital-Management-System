    ...
    <div  className='relative top-0 left-0'>
       ...
       <ul className=' absolute top-0 left-0 border overflow-x-auto bg-white-500  w-[300px] h-[100vh]   p-5' >
          ...
          <li>
            ...
            <img className='w-[50px] h-[50px] rounded-full' src='reception.jpg' alt=''></img><p><span className='text-xl text-yellow-700'>Reception<br></br> </span>Sudhan</p> </button>
          </li>
          <br></br>
          ...
          <li className='hover:scale-105 transition duration-500 ease-in-out'>
            <button onClick={()=>setPage("patient")} className='active:bg-green-700 grid grid-cols-[auto_1fr] gap-4  items-center  rounded-lg px-[20px] py-3 bg-white-700 font-bold  text-lg hover:bg-green-700 hover:text-gray-100 transition duration-200 ease-in-out'>
          ...
          <br></br>
          <li className='hover:scale-105 transition duration-500 ease-in-out'>
            <button onClick={()=>setPage("doctorschedule")} className='active:bg-green-700 grid grid-cols-[auto_1fr] gap-4  items-center  rounded-lg px-[20px] py-3 bg-white-700 font-bold  text-lg hover:bg-green-700 hover:text-gray-100 transition duration-200 ease-in-out'>
              <img className='w-[30px] h-[30px]' src='schedule.png'alt=''></img><p>Doctor Schedule</p>
            </button>
          </li>
          <br></br>
          <li className='hover:scale-105 transition duration-500 ease-in-out'>
            <button onClick={()=>setPage("counter")} className='active:bg-green-700 grid grid-cols-[auto_1fr] gap-4  items-center  rounded-lg px-[20px] py-3 bg-white-700 font-bold  text-lg hover:bg-green-700 hover:text-gray-100 transition duration-200 ease-in-out'>
              <img className='w-[30px] h-[30px]' src='bill.png'alt=''></img><p>Bill Counter</p>
            </button>
          </li>
          <br></br>
          <li className='hover:scale-105 transition duration-500 ease-in-out'>
            <button onClick={()=>setPage("bill")} className='w-[230px] active:bg-green-700 grid grid-cols-[auto_1fr] gap-4  items-center  rounded-lg px-[20px] py-3 bg-white-700 font-bold  text-center text-lg hover:bg-green-700 hover:text-gray-100 transition duration-200 ease-in-out'>
              <img className='w-[30px] h-[30px]' src='bill.png'alt=''></img><p className='ml-[-100px]'>Bills  </p>
            </button>
          </li>
