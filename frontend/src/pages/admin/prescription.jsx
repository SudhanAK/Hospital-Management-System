...
function Prescription() {
  ...
  return (
    <div>
      <p className='text-2xl font-bold text-center'>Prescription</p><br />
        ...
        <div key={index} className="mb-8">
           <table className="w-[900px] border-collapse shadow-lg rounded-xl overflow-hidden mt-6 mx-auto">
            ...
            <tbody className="divide-y divide-gray-200">
              ...
              <tr>
                <td className="px-4 py-3">Blood Pressure</td>
                <td className="px-4 py-3">{billData.bloodpressure || '--'}</td>
              </tr>
              <tr>
                <td className="px-4 py-3">Sugar</td>
                <td className="px-4 py-3">{billData.sugar || '--'}</td>
              </tr>
              <tr>
                <td className="px-4 py-3">Oxygen</td>
                <td className="px-4 py-3">{billData.oxygen || '--'}</td>
              </tr>
              <tr>
                <td className="px-4 py-3">Weight</td>
                <td className="px-4 py-3">{billData.weight || '--'}</td>
              </tr>
              <tr>
                <td className="px-4 py-3">Height</td>
                <td className="px-4 py-3">{billData.height || '--'}</td>
              </tr>
              <tr>
                <td className="px-4 py-3">Temperature</td>
                <td className="px-4 py-3">{billData.temperature || '--'}</td>
              </tr>
