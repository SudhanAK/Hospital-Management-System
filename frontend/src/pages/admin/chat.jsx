...
function chat() {
  ...
  useEffect(()=>{
    async function call(){  
    const res= await fetch('https://hospital-management-system-b06p.onrender.com/get-message',{
            method:"POST",
  ...
  function Fetch(e){
    e.preventDefault();
    fetch('https://hospital-management-system-b06p.onrender.com/update-message',{
            method:"POST",
            headers:{"Content-Type":"application/json"},
