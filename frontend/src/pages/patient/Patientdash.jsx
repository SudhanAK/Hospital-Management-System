...
function Admindash() {
  ...
  useEffect(() => {
    ...
    fetch('http://localhost:3000/patient-detail', {
      method: 'POST',
  ...
  return (
    <div className="relative top-0 left-0">
      ...
      <ul className="z-10 absolute top-0 left-[100px]  md:left-0 lg:left-0 border-0 lg:border   overflow-x-auto bg-white w-[300px] sm:w-[300px] md:w-[280px] lg:w-[300px] h-auto p-3 sm:p-4 md:p-5">
        <li className="grid grid-cols-[auto_1fr] items-center gap-2 px-1">
          <img
      ...
      {/* Top navbar */}
      <div className="absolute top-[440px] lg:top-0 left-[120px] sm:left-[250px] md:left-[280px] lg:left-[300px] bg-white w-[calc(100%-200px)] sm:w-[calc(100%-250px)] md:w-[calc(100%-280px)] lg:w-[1200px] h-[80px]">
        <ul className="border-b-2 border-grey-700 bg-grey-100 w-full h-[80px] grid grid-flow-col justify-end items-center">
          <li className="hover:scale-105 transition duration-500 ease-in-out">
            <button
              onClick={() => setPage('chat')}
              className="     mr-4 h-[50px] w-[170px] py-2 px-3 grid grid-cols-[auto_1fr] gap-4 items-center rounded-lg bg-white font-bold text-sm sm:text-md hover:bg-gray-300 hover:text-gray-700 text-[16px]"
            >
              <img
